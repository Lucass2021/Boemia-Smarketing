...
if (isset($_POST['BTEnvia'])) {
    ...
    //==================================================== 
    $email_remetente = "contato@boemiasmarketing.com.br"; // deve ser uma conta de email do seu dominio 
    //====================================================

    //Configurações do email, ajustar conforme necessidade
    //==================================================== 
    $email_destinatario = "contato@boemiasmarketing.com.br"; // pode ser qualquer email que receberá as mensagens
    $email_reply = "$email";
